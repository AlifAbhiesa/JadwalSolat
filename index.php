    ...
    <a href="kota.php"><div style="align-content: center" class="row m-b-30 dashboard-header">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="col-sm-12 card dashboard-product">
                        <span>Data Kota</span>
                        <h2 class="dashboard-total-products counter">316</h2>
        ...
        <?php
$str = file_get_contents('http://wahidganteng.ga/process/api/729f09fbfe94ae60c805aae8cacdcc57/jadwal-sholat?idk=14&bln=03&thn=2018');
                    ...
                    <div class="row">
                        <div class="col-lg-7 p-r-0 txt-white climacon-left">
                            <div class="card-block bg-primary">
                                <div class="m-b-5">
                                    <h4 class="dashboard-city">BANDUNG, ID</h4>
                                    
                                </div>
                                <div>
                                    <h6 class="cloud-date">11 March 2018</h6>
